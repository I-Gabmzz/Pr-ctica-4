...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("Domino Demo", 1000, 1000,
                    Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
        ...
        else if(colorString.equals("bone white")) {
            graphic.setColor(new Color(227, 218, 201));
        }
        else if(colorString.equals("lime green")) {
            ...
            graphic.setColor(new Color(255, 247, 217));
        } else {
            graphic.setColor(Color.black);
        }
    }
